...
import yaml
from python_script.test_seg_x import test_seg_x
from python_script.train_seg_x import train_seg_x
import torch
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        test_seg_x(config, test_basedir, checkpoint=checkpoint)

    elif args.test:
        os.environ["CUDA_VISIBLE_DEVICES"] = config["TestConfig"]["gpu"]
        test_seg_x(config, basedir, args.checkpoint)
    end_time = time.time()
