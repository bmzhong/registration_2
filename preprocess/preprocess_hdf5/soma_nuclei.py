...
if __name__ == '__main__':
    ...
    source_path = r'G:\biomdeical\registration\data\preprocess\merge_label\soma_nuclei\soma_nuclei'
    allen_path = r'G:\biomdeical\registration\data\preprocess\merge_label\allen\allen'
    output_path = '../../datasets/hdf5/soma_nuclei.h5'
    write_soma_nuclei(image_size, source_path, allen_path, output_path, scale_factor)

    hdf5_path = '../../datasets/hdf5/soma_nuclei.h5'
    output_dir = r'G:\biomdeical\registration\data\datasets'
    extract_hdf5(hdf5_path, output_dir)
