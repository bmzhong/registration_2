...
class XMorpherReg(nn.Module):
    def __init__(self, n_channels=1, patch_size=(4, 4, 4), scale=1):
        super().__init__()
        embed_dim = 48
        self.scale = scale
        self.patch_embed = PatchEmbed3D(
        ...
        self.swin = XMorpher(window_size=(
        ...
        self.flow = nn.Conv3d(embed_dim // 2, 3, 3, padding=1)
...
if __name__ == '__main__':
    ...
    Reger = XMorpherReg(n_channels=n_channels, patch_size=(8, 8, 8))
